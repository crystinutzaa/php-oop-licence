...
<div class="d-flex flex-column flex-md-row align-items-center p-3 px-md-4 mb-3 bg-white border-bottom shadow-sm">
  ...
  <a class="btn btn-outline-primary" href="./index.php?controller=index&action=createaccount">Create Account</a>
</div>
    ...
    <div class="col-md-3">
        <form action="<?php echo $_SERVER['REQUEST_URI'] ?>" method='post'>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="login" name="login[email]" value='<?= $login->email ?>' placeholder="Email">
            </div>
