...
<div class="d-flex flex-column flex-md-row align-items-center p-3 px-md-4 mb-3 bg-white border-bottom shadow-sm">
    <h5 class="my-0 mr-md-auto font-weight-normal">
        <a class="license-sys" href="./index.php?controller=index&action=index<?php if ($licenseIsExpired) {
    echo '&expiredLicense=1';
}?>">License System</a>
    </h5>
    ...
    <div class = "card-deck mb-3 text-center">
        <div class="card mb-4 shadow-sm">
            <div class="card-header">
                <h4 class="my-0 font-weight-normal <?php if ($licenseIsExpired) {
        echo 'alert alert-danger';
    } ?>"> <?php echo $license->name .' - Expires: ' . $expirationDate ?></h4>
            </div>
            <div class="card-body">
                ...
                <form action="<?php echo $_SERVER['REQUEST_URI'] ?>" method='post'>
                    ...
                    <div class="">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" class="form-control"  name="websites[id_website][]" value='<?php if (isset($websites[$i])) {
                                    echo $websites[$i]->id_website;
                                } ?>'>
                                            ...
                                            <input type="text" class="form-control"  name="websites[url][]" value='<?php if (isset($websites[$i])) {
                                                    echo $websites[$i]->url;
                     ...
                     <button type="submit" class="btn btn-primary" <?php if ($licenseIsExpired) {
                                echo 'disabled';
                            } ?> >Submit Websites</button>
